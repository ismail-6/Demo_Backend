...
func GetAllChaptersRaw(c *gin.Context) {
...
func GetChapterByIDRaw(c *gin.Context) {
...
func GetChapterVideoRaw(c *gin.Context) {
	chapterID := c.Param("id")
	sqlDB, _ := database.DB.DB()
...
func GetChapterQuizRaw(c *gin.Context) {
	chapterID := c.Param("id")
	sqlDB, _ := database.DB.DB()
...
func GetChapterContentRaw(c *gin.Context) {
	chapterID := c.Param("id")
	sqlDB, _ := database.DB.DB()
